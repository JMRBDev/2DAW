/**
 * Interfaz que contiene todos los atributos de cada usuario
 */
interface IUsuario {
  usuario: string;
  contrasena: string;
...
/**
 * Interfaz que contiene todos los atributos de cada artículo
 */
interface IArticulo {
  codigo: number;
  descripcion: string;
...
const imgProductos: string[] = ["0.jpg", "1.jpg", "2.jpg", "3.jpg", "4.jpg", "5.jpg"];
const descripcionesProductos: string[] = ["Intel Core i7", "Portátil Acer", "LG K61", "LG Ultrawide", "MSI Gaming", "Gigabyte Gaming"];
const unidadesProductos: number[] = [250, 85, 302, 42, 67, 12];
const preciosProductos: number[] = [229, 390, 189, 449, 989, 1029];
...
const iniciarSesion: Function = () => {
  ...
  const username: string = (document.getElementById(
    "username"
  ) as HTMLInputElement).value;
  const password: string = (document.getElementById(
    "password"
  ) as HTMLInputElement).value;
 ...
 */
const cerrarSesion: Function = (): void => {
 ...
 */
const anadirAlCarrito: Function = (unidades: number, codigo: number): void => {
 ...
 */
const mostrarOcultarElementosSesion: Function = (accion: string): void => {
